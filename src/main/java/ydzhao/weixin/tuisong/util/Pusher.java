...
public class Pusher {
     ...
     * 测试号的appId和secret
     */
    private static String appId = "wx493aa1098e102d01";
    private static String secret = "28963ec15cdb9278aff1bc1e233c7f77";
    //模版id
    private static String templateId = "YP2Dx9JYXuScFtqJBWS7sSvXO2QdZHWJjKvmK2QN-VQ";

    public static void push(String openIds){
        for (String openId : openIds.split("[,，]")) {
            ...
            templateMessage.addData(new WxMpTemplateData("tianqi",todayWeather.getString("text_day"),"#FFCC80"));
            templateMessage.addData(new WxMpTemplateData("low",todayWeather.getString("low") + "","#81D4FA"));
            ...
            templateMessage.addData(new WxMpTemplateData("jinju",CaiHongPi.getJinJu()+"","#AED581"));
